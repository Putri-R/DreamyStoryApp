package com.myapp.dreamystory.ui
...
import com.myapp.dreamystory.DataDummy
import com.myapp.dreamystory.getOrAwaitValue
import com.myapp.dreamystory.MainDispatcherRule
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(repository.getListStory()).thenReturn(expectedStory)
